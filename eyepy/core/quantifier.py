...
class DefaultEyeQuantifier(EyeQuantifier):
    ...
    def regions(self, oct_obj):
        ...
        if self._regions is None:
            ...
            masks = create_region_masks(
                ...
                radii=radii_enface_space, n_sectors=[4, 1, 1],
                rotation=[45, 0, 0], center=oct_obj.fovea_pos,
                smooth_edges=False, ring_sectors=True, add_circle_masks=True, )
    ...
    def plot_primitives(self, oct_obj):
        ...
        return create_region_shape_primitives(
            (oct_obj.SizeXSlo, oct_obj.SizeYSlo), radii=radii_enface_space,
            n_sectors=[4, 1, 1], rotation=[45, 0, 0], center=oct_obj.fovea_pos)
    ...
    def quantify(self, oct_obj, space="enface"):
        ...
        """
        oct_voxel_size_µm3 = (oct_obj.ScaleX * 1e3 * oct_obj.Distance * 1e3
                              * oct_obj.ScaleZ * 1e3)
        enface_voxel_size_µm3 = (oct_obj.ScaleXSlo * 1e3
                                 * oct_obj.ScaleYSlo * 1e3
                                 * oct_obj.ScaleZ * 1e3)
