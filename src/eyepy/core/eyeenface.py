...
from eyepy.core.annotations import EyeEnfacePixelAnnotation, EyeEnfaceOpticDiscAnnotation, EyeEnfaceFoveaAnnotation
...
class EyeEnface:
    ...
    def _validate_laterality(self) -> None:
        """Validate that laterality matches the relative position of optic disc and fovea.
