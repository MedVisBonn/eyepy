...
from eyepy.core.eyemeta import EyeVolumeMeta, EyeEnfaceMeta, EyeBscanMeta
...
class TestEyeVolumeSaveLoadTransform:
    ...
    def test_save_and_load_custom_transform(self, eyevolume_with_custom_transform):
        """Test that a custom localizer_transform is saved and loaded correctly."""
    ...
    def test_save_and_load_default_transform(self):
        """Test that the default computed transform is saved and loaded correctly."""
    ...
    def test_backward_compatibility_no_transform_file(self):
        """Test that loading old files without transform_params.npy still works."""
